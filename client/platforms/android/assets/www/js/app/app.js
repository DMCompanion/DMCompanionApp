...
angular.module('companion', ['ionic', 'angularMoment', 'flexcalendar', 'flexcalendar.defaultTranslation', 'ionic-pullup', 'angular-md5', 'ngCordova']).run(function ($ionicPlatform) {
